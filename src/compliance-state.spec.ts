import { openOrCreateDb, writeDb, submitDocument, createRecord, checkRequirements } from './compliance-state';
...
describe('compliance state', () => {
  ...
  describe('openOrCreateDb', () => {
    it('returns an object if the open function throws', () => {
      const readFile: any = () => { throw new Error('testing'); }
